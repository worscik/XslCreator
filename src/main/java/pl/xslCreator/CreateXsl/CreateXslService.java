...
public class CreateXslService implements CreateXsl{
    ...
    @Override
    public String createStandardXsl(FieldsDto fieldsDto, boolean isMappingCorrect, String headers ,CreateXslResponse response) {
        String xslFile =  templateService.buildStandardFile(fieldsDto,headers);
